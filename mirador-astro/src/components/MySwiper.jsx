            ...
            <div className="video-wrapper">
              ...
              >
                ...
                <svg width="154" height="154" viewBox="0 0 154 154" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M76.9 152.8C118.818 152.8 152.8 118.818 152.8 76.9C152.8 34.9816 118.818 1 76.9 1C34.9816 1 1 34.9816 1 76.9C1 118.818 34.9816 152.8 76.9 152.8Z" stroke="#12819E" stroke-width="2" stroke-miterlimit="10"></path>
                  </g>
                  <defs>
        ...
        return (
          <SwiperSlide key={slide.src + index}>
            ...
            <svg width="209" height="36" viewBox="0 0 209 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="paint0_linear_46_2" x1="0" y1="17.99" x2="37.83" y2="17.99" gradientUnits="userSpaceOnUse"><stop stop-color="#33baba"></stop><stop offset="1" stop-color="#8fbee6"></stop></linearGradient>
                <linearGradient id="paint1_linear_46_2" x1="42.55" y1="0" x2="80.38" y2="0" gradientUnits="userSpaceOnUse"><stop stop-color="#33baba"></stop><stop offset="1" stop-color="#8fbee6"></stop></linearGradient>
                <linearGradient id="paint2_linear_46_2" x1="85.1" y1="0" x2="122.93" y2="0" gradientUnits="userSpaceOnUse"><stop stop-color="#33baba"></stop><stop offset="1" stop-color="#8fbee6"></stop></linearGradient>
                <linearGradient id="paint3_linear_46_2" x1="127.65" y1="0" x2="165.48" y2="0" gradientUnits="userSpaceOnUse"><stop stop-color="#33baba"></stop><stop offset="1" stop-color="#8fbee6"></stop></linearGradient>
                <linearGradient id="paint4_linear_46_2" x1="170.2" y1="0" x2="208.03" y2="0" gradientUnits="userSpaceOnUse"><stop stop-color="#33baba"></stop><stop offset="1" stop-color="#8fbee6"></stop></linearGradient>
